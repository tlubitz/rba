...
class ProblemRBA(object):
    ...
    def __init__(self,matrix,ModelStructure,lp_solver="cplex"):
        ...
        if not lp_built:
            ...
            #warnings.warn('Unable to build LP-solver object')
            #return()
    ...
    def find_growth_rate_dependencies(self,ModelStructure):
        ...
        MuDepIndices_A+=get_medium_dependent_coefficients_in_lhs(ModelStructure)
    ...
    def solve_lp(self, feasible_stati: list = ["optimal","feasible"], try_unscaling_if_sol_status_is_feasible_but_not_optimal: bool =True):
        """
        ...
        try_unscaling_if_sol_status_is_feasible_but_not_optimal :bool
            Try re-solving problem with less aggressive scaling, when solution status is feasible but not optimal
            Default: True
        """
        ...
        try:
            ...
            if self.SolutionStatus in feasible_stati:
                ...
                if self.SolutionStatus == 5:
                    if try_unscaling_if_sol_status_is_feasible_but_not_optimal:
