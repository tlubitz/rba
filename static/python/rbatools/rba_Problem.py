...
class RBA_Problem(object):
    ...
    getCompartmentCapacities(compartments)
    ...
    def solveLP(self, feasibleStatuses=[1], logging=True):
        """
        Solves Linear RBA problem.
    ...
    def getConstraintType(self, constraints=None):
        """
    ...
    def getObjective(self, variables=None):
        """
        Returns objective coefficient of variables in problem.
    ...
    def getRighthandSideValue(self, constraints=None):
        """
        Extracts coefficients of problem's righthand side (B-vector).
    ...
    def calculateLefthandSideValue(self, constraints=None):
        """
        Calculates value of problem's lefthand side
        (after multiplying with solution-vector).
    ...
    def getCompartmentCapacities(self, compartments=None):
        """
        Returns of capacity coefficients of compartments in problem.
